...
- `code/intermediates/inference_inputs/readiness_training_rows.csv` (from the
  prior script).
...
- Input rows file path as `code/intermediates/inference_inputs/readiness_training_rows.csv`.
